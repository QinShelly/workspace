...
CASE WHEN age <= 39
     ...
     THEN CASE WHEN education_method IN ('普通', '普通全日制', '研究生')
               THEN CASE
                   WHEN wsl_rank < 10  THEN 200 + CASE WHEN sex = '女' THEN 10 ELSE 0 END
                   WHEN wsl_rank < 20  THEN 150 + CASE WHEN sex = '女' THEN 10 ELSE 0 END
                   WHEN wsl_rank < 40  THEN 100 + CASE WHEN sex = '女' THEN 10 ELSE 0 END
                   WHEN wsl_rank < 80  THEN 75  + CASE WHEN sex = '女' THEN 10 ELSE 0 END
                   WHEN wsl_rank < 120 THEN 75  + CASE WHEN sex = '女' THEN 10 ELSE 0 END
